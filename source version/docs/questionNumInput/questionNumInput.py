...
class Ui_QuestionNumInput(object):
    ...
    '''
    clickX, clickY = -1, -1
    '''Temporary variable for storing click points
        '''
    clickCoordinates = []
    '''Temporary variable for storing clicked points
    '''
    problemCoordinateList = []
    '''Temporary variable for storing dragged problem marking areas
    '''
    problemIsAnswerList = []
    '''A temporary variable, True or False, that stores the correct answers for each dragged marking area.
    '''
...
"background-color: rgb(0, 85, 255);")
    ...
    def mouseCallbackSpot(self, event, x, y):
        """Method for storing mouse click coordinates
    ...
    def showPopupUnmarkedPaperInput(self):
        """Prompt for guidance before entering unmarked test papers
        :return: nothing
        """
    ...
    def showPopupEdgeInstruction_1(self):
        """Prompt for guidance before specifying the coordinates for each edge of the test paper
...
class popupUnmarkedClass(object):
    """Unmarked Test Paper Input Prompt Class
    """
    def setupUi(self, Form):
        """This function is intended to set the initial UI.
...
class popupEdgeInstructionClass_1(object):
    """Pop-up class for specifying each vertex of the test paper
    """
    def setupUi(self, Form):
        """This function is intended to set the initial UI.
