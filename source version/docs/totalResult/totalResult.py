...
class popupExcelSavedClass(object):
    """Notification window when saving results as an Excel file
    """
...
class Ui_totalResult(object):
    ...
    def resultPushButtonClicked(self, data):
        """Behavior when clicking the Create Excel File button
    ...
    def studentNameComboBoxClicked(self, name):
        """When selecting someone else in the above checkbox, the screen information is changed to someone else's.
    ...
    def setupUi(self, Form, totalProblemList, totalResults, gradeWithOCR):
        """This function is intended to set the initial UI.
...
"background-color: rgb(0, 85, 255);")
    ...
    def changeInfo(self, personLocation):
        """Replace information on the screen with that of a person in the personLocation index
    ...
    def getAnswerOfProblem(self, problem):
        """Insert 'eachProblemInfo' class object to return the correct answer selection number for that question

        :param problem: question array
        :return:
        """
